...
{
    [Indicator(ScalePrecision = 5, AutoRescale = false, IsOverlay = false, AccessRights = AccessRights.FullAccess)]
	[Levels()]
...
Mq4String name = "";
Mq4Double i = 0;
Mq4Double lookForLength = 0;
   lookForLength = StringLen("signalLines");
   for (i=ObjectsTotal(); i>=0; i--)
      {
         name = ObjectName(i);
         if (StringSubstr(name,0,lookForLength)=="signalLines") ObjectDelete(name);
      }
   return 0;
return 0;}
Mq4Double Mq4Start()
...
Fish2=0;
   ...
   for(i=limit; i>=0; i--)
   {
      ...
      if (ExtBuffer3[i+1] < 0 && ExtBuffer3[i] > 0)
      {
         ...
         {
            sAlertMsg="Solar: "+Symbol.Code+" -> UP ("+TF2StrFunc(Period())+")";
            if (DoAlert)     Alert(sAlertMsg);
            lastAlertTime = Time[0];  
            if (alertMail)   SendMail("cTrader "+sAlertMsg, "cTrader Alert!\n" + TimeToStr(TimeCurrent(),TIME_DATE|TIME_SECONDS )+"\n"+sAlertMsg);   
         }
      }
      else if( ExtBuffer3[i+1] > 0 && ExtBuffer3[i] < 0)
      {
         ...
         {
            sAlertMsg="Solar: "+Symbol.Code+" -> DOWN ("+TF2StrFunc(Period())+")";
            if (DoAlert)     Alert(sAlertMsg);
            lastAlertTime = Time[0];  
            if (alertMail)   SendMail("cTrader "+sAlertMsg, "cTrader Alert!\n" + TimeToStr(TimeCurrent(),TIME_DATE|TIME_SECONDS )+"\n"+sAlertMsg);   
         }
   ...
   return 0;
return 0;}
Mq4String TF2StrFunc(Mq4Double iPeriod)
{
switch(iPeriod) {
    			case PERIOD_M1:
			case PERIOD_M5:
...
//}
[Parameter("period", DefaultValue = 35)]
public int period_parameter { get; set; }
bool _periodGot;
Mq4Double period_backfield;
Mq4Double period { get { if (!_periodGot) period_backfield = period_parameter; return period_backfield;	} set { period_backfield = value; } }

[Parameter("smooth", DefaultValue = 10)]
public int smooth_parameter { get; set; }
bool _smoothGot;
Mq4Double smooth_backfield;
Mq4Double smooth { get { if (!_smoothGot) smooth_backfield = smooth_parameter; return smooth_backfield;	} set { smooth_backfield = value; } }

[Parameter("alertLevel", DefaultValue = 7)]
public int alertLevel_parameter { get; set; }
bool _alertLevelGot;
Mq4Double alertLevel_backfield;
Mq4Double alertLevel { get { if (!_alertLevelGot) alertLevel_backfield = alertLevel_parameter; return alertLevel_backfield;	} set { alertLevel_backfield = value; } }

[Parameter("DoAlert", DefaultValue = true)]
public bool DoAlert_parameter { get; set; }
bool _DoAlertGot;
Mq4Double DoAlert_backfield;
Mq4Double DoAlert { get { if (!_DoAlertGot) DoAlert_backfield = DoAlert_parameter; return DoAlert_backfield;	} set { DoAlert_backfield = value; } }

[Parameter("alertMail", DefaultValue = false)]
public bool alertMail_parameter { get; set; }
bool _alertMailGot;
Mq4Double alertMail_backfield;
Mq4Double alertMail { get { if (!_alertMailGot) alertMail_backfield = alertMail_parameter; return alertMail_backfield;	} set { alertMail_backfield = value; } }



[Output("ExtBufferh1", Color = Colors.LimeGreen, PlotType = PlotType.Histogram)]
public IndicatorDataSeries ExtBufferh1_AlgoOutputDataSeries { get; set; }
[Output("ExtBufferh2", Color = Colors.Red, PlotType = PlotType.Histogram)]
public IndicatorDataSeries ExtBufferh2_AlgoOutputDataSeries { get; set; }
[Output("ExtBuffer3", Color = Colors.Gold, PlotType = PlotType.DiscontinuousLine)]
public IndicatorDataSeries ExtBuffer3_AlgoOutputDataSeries { get; set; }
[Output("ExtBuffer4", Color = Colors.LimeGreen, PlotType = PlotType.DiscontinuousLine)]
public IndicatorDataSeries ExtBuffer4_AlgoOutputDataSeries { get; set; }
[Output("ExtBuffer5", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
public IndicatorDataSeries ExtBuffer5_AlgoOutputDataSeries { get; set; }
public IndicatorDataSeries ExtBuffer0_AlgoOutputDataSeries { get; set; }
public IndicatorDataSeries ExtBuffer1_AlgoOutputDataSeries { get; set; }
public IndicatorDataSeries ExtBuffer2_AlgoOutputDataSeries { get; set; }

     
Mq4Double lastAlertTime;
		
int indicator_buffers = 5;
int indicator_color1 = LimeGreen;
int indicator_color2 = Red;
int indicator_color3 = Gold;
int indicator_color4 = LimeGreen;
int indicator_color5 = Red;
...
private Mq4OutputDataSeries ExtBufferh1;
private Mq4OutputDataSeries ExtBufferh2;
private Mq4OutputDataSeries ExtBuffer3;
private Mq4OutputDataSeries ExtBuffer4;
private Mq4OutputDataSeries ExtBuffer5;
private Mq4OutputDataSeries ExtBuffer0;
private Mq4OutputDataSeries ExtBuffer1;
private Mq4OutputDataSeries ExtBuffer2;
...
public List<DataSeries> AllOutputDataSeries = new List<DataSeries>();
        ...
        {
if (ExtBufferh1_AlgoOutputDataSeries == null) ExtBufferh1_AlgoOutputDataSeries = CreateDataSeries();
ExtBufferh1 = new Mq4OutputDataSeries(this, ExtBufferh1_AlgoOutputDataSeries, ChartObjects, 2, 0, () => CreateDataSeries(), 1, Colors.LimeGreen);
AllBuffers.Add(ExtBufferh1);
if (ExtBufferh2_AlgoOutputDataSeries == null) ExtBufferh2_AlgoOutputDataSeries = CreateDataSeries();
ExtBufferh2 = new Mq4OutputDataSeries(this, ExtBufferh2_AlgoOutputDataSeries, ChartObjects, 2, 1, () => CreateDataSeries(), 1, Colors.Red);
AllBuffers.Add(ExtBufferh2);
if (ExtBuffer3_AlgoOutputDataSeries == null) ExtBuffer3_AlgoOutputDataSeries = CreateDataSeries();
ExtBuffer3 = new Mq4OutputDataSeries(this, ExtBuffer3_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 2, Colors.Gold);
AllBuffers.Add(ExtBuffer3);
if (ExtBuffer4_AlgoOutputDataSeries == null) ExtBuffer4_AlgoOutputDataSeries = CreateDataSeries();
ExtBuffer4 = new Mq4OutputDataSeries(this, ExtBuffer4_AlgoOutputDataSeries, ChartObjects, 0, 3, () => CreateDataSeries(), 2, Colors.LimeGreen);
AllBuffers.Add(ExtBuffer4);
if (ExtBuffer5_AlgoOutputDataSeries == null) ExtBuffer5_AlgoOutputDataSeries = CreateDataSeries();
ExtBuffer5 = new Mq4OutputDataSeries(this, ExtBuffer5_AlgoOutputDataSeries, ChartObjects, 0, 4, () => CreateDataSeries(), 2, Colors.Red);
AllBuffers.Add(ExtBuffer5);
if (ExtBuffer0_AlgoOutputDataSeries == null) ExtBuffer0_AlgoOutputDataSeries = CreateDataSeries();
ExtBuffer0 = new Mq4OutputDataSeries(this, ExtBuffer0_AlgoOutputDataSeries, ChartObjects, 12, 5, () => CreateDataSeries(), 1, null);
AllBuffers.Add(ExtBuffer0);
if (ExtBuffer1_AlgoOutputDataSeries == null) ExtBuffer1_AlgoOutputDataSeries = CreateDataSeries();
ExtBuffer1 = new Mq4OutputDataSeries(this, ExtBuffer1_AlgoOutputDataSeries, ChartObjects, 12, 6, () => CreateDataSeries(), 1, null);
AllBuffers.Add(ExtBuffer1);
if (ExtBuffer2_AlgoOutputDataSeries == null) ExtBuffer2_AlgoOutputDataSeries = CreateDataSeries();
ExtBuffer2 = new Mq4OutputDataSeries(this, ExtBuffer2_AlgoOutputDataSeries, ChartObjects, 12, 7, () => CreateDataSeries(), 1, null);
AllBuffers.Add(ExtBuffer2);

AllOutputDataSeries.Add(ExtBufferh1_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBufferh2_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBuffer3_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBuffer4_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBuffer5_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBuffer0_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBuffer1_AlgoOutputDataSeries);
AllOutputDataSeries.Add(ExtBuffer2_AlgoOutputDataSeries);
    ...
    public override void Calculate(int index)
    {
		...
		{
			_currentIndex = index;
			ExtBufferh1.SetCurrentIndex(index);
ExtBufferh2.SetCurrentIndex(index);
ExtBuffer3.SetCurrentIndex(index);
ExtBuffer4.SetCurrentIndex(index);
ExtBuffer5.SetCurrentIndex(index);
ExtBuffer0.SetCurrentIndex(index);
ExtBuffer1.SetCurrentIndex(index);
ExtBuffer2.SetCurrentIndex(index);
